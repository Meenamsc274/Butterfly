...
if(isset($_POST['submit'])){
    if($_POST['submit']=='Create'){
        ...
        if(mysqli_query($link,"INSERT INTO `branch_tbl` ( `branch_id`, `branch_name`, `ip_address`, `browser`, `date`, `created_by`, `approved_by`) VALUES ( '$autoid', '$name', '$ip_address', '$browser', NOW(), '$created_by', '$approved_by')")){
    ...
    if($_POST['submit']=='Update'){
        ...
        if(mysqli_query($link,"update `branch_tbl` set `branch_name`='$name', `ip_address`='$ip_address', `browser`='$browser', `date`=NOW(), `created_by`='$created_by', `approved_by`='$approved_by' where branch_id = '$autoid'")){
...
if($_GET['del'] == "yes"){
	$autoid=$_GET['autoid'];
    if(mysqli_query($link,"delete from `branch_tbl` where `branch_id`='$autoid'")){
            	...
            	<div class="container box-bg">
            		<div class="box">
	              		<div class="box-header">
	              			<div class="row">
	              				<div class="col-lg-6">
                                    <h3 class="box-heading">Manage Branch 
	              		...
	              		<div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <?php $page="branch"; include "assets/common/side_menu.php"; ?>
                                </div>
                                <div class="col-lg-9">
                                        ...
                                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <button class="btn btn-sm btn-success edit" id="edit<?php echo $row->branch_id ; ?>"  type="button" data-bs-toggle="modal" data-bs-target="#myModalEdit"><i class="fa fa-edit"></i></button>
                                                        <a class="btn btn-sm bg-danger text-white" href="branch.php?branch_id=<?php echo $row->branch_id; ?>&del=yes" title="Delete Details"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $i++; } ?>
                                            </tbody>
             ...
             <div class="modal" id="myModal">
                <div class="modal-dialog">
                    ...
                    <form method="post" class="padding-10" enctype="multipart/form-data">
                        <?php   $max_id = maxOfAll("id","branch_tbl");
                                $max_id=$max_id+1;
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit').click(function(){
                ...
                var url = 'ajax_request/get_branch.php';
                $.ajax({
                    url : url,
                    type: "POST",
                    data: {id : id},
