                ...
                <div class="box">
                    ...
                    <div class="box-body">
                      ...
                      <form method="post" class="padding-10" enctype="multipart/form-data">
                        <?php
 $department_id = mysqli_real_escape_string($link,$_GET['department_id']);
  $update = mysqli_real_escape_string($link,$_GET['update']);
  if($update == "yes"){
  $sel_row = mysqli_query($link,"select * from department_tbl where `department_id`='$department_id'");
  $row = mysqli_fetch_object($sel_row);
  $upload_id = $row->department_id;
  }
  else
  {
  $max_id = maxOfAll("id","department_tbl");
  $max_id=$max_id+1;
  ...
  <div class="alert alert-success alert-dismissible">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
      <div class="form-group row">
        ...
        <label class="margin-left-10" for="industry_name">Department Id</label>
        </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
      <div class="form-group row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-pad">
        <label class="margin-left-10" for="industry_name">Department Name</label>
        </div>
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-pad">
          <input type="text" class="form-control" name="department_name" id="department_name" placeholder="Enter the Department Name" value="<?php echo $row->department_name; ?>"required="required">
        </div>
      </div>
    </div>
