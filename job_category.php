...
if(isset($_POST['submit'])){
    if($_POST['submit']=='Create'){
        ...
        if(mysqli_query($link,"INSERT INTO `job_category` ( `autoid`, `title`, `ip_address`, `browser`, `date`, `created_by`, `approved_by`) VALUES ( '$autoid', '$title', '$ip_address', '$browser', NOW(), '$created_by', '$approved_by')")){
    ...
    if($_POST['submit']=='Update'){
        ...
        if(mysqli_query($link,"update `job_category` set `title`='$title', `ip_address`='$ip_address', `browser`='$browser', `date`= NOW(), `created_by`='$created_by', `approved_by`='$approved_by' where autoid = '$autoid'")){
...
if($_GET['del'] == "yes"){
	$autoid=$_GET['autoid'];
    if(mysqli_query($link,"delete from `job_category` where `autoid`='$autoid'")){
            	...
            	<div class="container box-bg">
            		<div class="box">
	              		<div class="box-header">
	              			<div class="row">
	              				<div class="col-lg-6">
                                    <h3 class="box-heading">Manage Job Category 
                                    <div class="breadcrumb">
	              						<a href="index.php" class="breadcrumb_a">Home</a> 
                            			<i class="fa fa-angle-double-right angle_double_right"></i>
		              					<a href="#" class="breadcrumb_a"> Job Category </a> 
	              					</div>
                                </div>
                                    </h3> 
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="form_box_shadow p-4">
                                        ...
                                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php $i=1;
                                                $sel_rw = mysqli_query($link,"select * from job_category");
                                                ...
                                                <tr>
                                                    ...
                                                    <button class="btn btn-sm btn-success edit" id="edit<?php echo $row->autoid ; ?>"  type="button" data-bs-toggle="modal" data-bs-target="#myModalEdit"><i class="fa fa-edit"></i></button>
                                                        ...
                                                        <a class="btn btn-sm bg-danger text-white" href="job_category.php?autoid=<?php echo $row->autoid; ?>&del=yes" title="Delete Details"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $i++; } ?>
                                            </tbody>
             ...
             <div class="modal" id="myModal">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Create New Job Category</h4>
                    ...
                    <form method="post" class="padding-10" enctype="multipart/form-data">
                        <?php   $max_id = maxOfAll("id","job_category");
                                $max_id=$max_id+1;
                                $upload_id="JC-".$max_id;
                         ?>
                        <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit').click(function(){
                ...
                var url = 'ajax_request/get_job_category.php';
                $.ajax({
                    url : url,
                    type: "POST",
                    data: {id : id},
