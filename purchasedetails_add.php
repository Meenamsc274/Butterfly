...
if($_POST['submit'] == "Submit"){
    ...
    $purchase_id = mysqli_real_escape_string($link,$_POST['purchase_id']);
    $max_id = maxOfAll("id","purchase_tbl");
    $max_id=$max_id+1;
    $purchase_id="pur-".$max_id;	
    ...
    $type = "png";
    $rand = rand();
    $file = "barcode/purchase/$purchase_id"."_".date("d-m-Y")."_".$rand;
    ...
    $max_id = maxOfAll("id","purchasedetails_tbl");
    $max_id=$max_id+1;
    $purchasedetails_id="pd-".$max_id;	
    ...
    //Stock Module
    $sel_qty = mysqli_query($link,"select `product_id`,`qty` from purchasedetails_tbl where `purchase_id`='$purchase_id'");
    while($row_qty = mysqli_fetch_object($sel_qty)){
        $oldproduct[] = $row_qty->product_id.",".$row_qty->qty;
    }
    //End Stock Module
    
    mysqli_query($link,"delete from purchasedetails_tbl where `purchase_id`='$purchase_id'");
    $product_id1 = $_POST['product_id'];
    $i=0;
    foreach($product_id1 as $product_id2){
    $max_id = maxOfAll("id","purchasedetails_tbl");
              ...
              <div class="container box-bg">
                <div class="box">
                    <div class="box-header">
                      <div class="row">
                        <div class="col-lg-6"><h3 class="box-heading"> Purchase <small>Add / Update  Details</small></h3></h3></div>
                        <div class="col-lg-6">
                          <div class="breadcrumb">
                            <a href="index.php" class="breadcrumb_a">Home</a> 
                            <i class="fa fa-angle-double-right angle_double_right"></i>
                            <a href="purchase_view.php" class="breadcrumb_a">Purchase </a> 
                            <i class="fa fa-angle-double-right angle_double_right" aria-hidden="true"></i>
                            <a href="#" class="breadcrumb_a">Add / Update Purchase </a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="box-body">
                      ...
                      <form method="post" class="padding-10" enctype="multipart/form-data">
                        <?php
$purchase_id = mysqli_real_escape_string($link,$_GET['purchase_id']);
  $update = mysqli_real_escape_string($link,$_GET['update']);
  if($update == "yes"){
  $sel_row = mysqli_query($link,"select * from purchase_tbl where `purchase_id`='$purchase_id'");
  $row = mysqli_fetch_object($sel_row);
  
  $upload_id = $purchase_id;
  }
  else
  {
  $max_id = maxOfAll("id","purchase_tbl");
...
<input type="hidden" class="form-control" name="id" id="id" placeholder="Enter the Id" value="<?php echo $row->id; ?>" readonly="readonly">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
      <div class="form-group row">
        ...
        <input type="text" class="form-control" name="purchase_id" id="purchase_id" placeholder="Enter the Purchase Id" value="<?php echo $upload_id; ?>" readonly="readonly">
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
      <div class="form-group row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-pad">
        <input type="date" class="form-control" name="purchase_date" id="purchase_date" placeholder="Enter the Purchase Date" value="<?php echo $row->purchase_date; ?>" required="required">
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad">
		<table class="table table-bordered mg-none table1">
			...
			<tbody class="">
			<tr class="purchase_details"></tr>
			  <?php
			  if($update == "yes"){
			  $i = 0;
			  $sel = mysqli_query($link,"select * from purchasedetails_tbl where purchase_id='$purchase_id'");
			  while($row_purchase = mysqli_fetch_object($sel)){
			  ?>
			  <tr class="purchase_details" id="<?php echo $row_purchase->product_id; ?>">
				<td width="25%">
...
<script type="text/javascript" src="assets/js/purchasedetails_tbl.js"></script>
