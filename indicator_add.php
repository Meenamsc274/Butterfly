...
//echo "INSERT INTO `indicator` (`autoid`, `branch`, `department`, `designation`, `business_process`, `allocating_resource`, `oral_communication`, `project_management`, `leadership`,`added_by`,`created_at`) VALUES ('$autoid', '$branch', '$department', '$designation', '$business', '$allocating', '$oral', '$project', '$leader','Butterfly Paints','$date')";
if(mysqli_query($link,"INSERT INTO `indicator` (`autoid`, `employee`, `branch`, `department`, `designation`, `business_process`, `allocating_resource`, `oral_communication`, `project_management`, `leadership`,`overall`,`added_by`,`created_at`) VALUES ('$autoid', '$employee', '$branch', '$department', '$designation', '$business', '$allocating', '$oral', '$project', '$leader','$overall','Butterfly Paints','$date')")){
