...
$unit_id = mysqli_real_escape_string($link,$_POST['unit_id']);
...
if(mysqli_query($link,"INSERT INTO `unit_tbl` (`id`, `unit_id`, `unit_name`, `description`, `ip_address`, `browser`, `date`, `created_by`, `approved_by`, `status`, `sort_order`) VALUES ('$id', '$unit_id', '$unit_name', '$description', '$ip_address', '$browser', '$date', '$created_by', '$approved_by', '$status', '$sort_order')")){
...
$status = mysqli_real_escape_string($link,$_POST['status']);
$sort_order = mysqli_real_escape_string($link,$_POST['sort_order']);
if(mysqli_query($link,"UPDATE `unit_tbl` SET `unit_name` = '$unit_name', `description` = '$description', `ip_address` = '$ip_address', `browser` = '$browser', `date` = '$date', `created_by` = '$created_by', `approved_by` = '$approved_by', `status` = '$status', `sort_order` = '$sort_order' WHERE `unit_id`='$unit_id'")){
	$msg[] = "Successfully Saved!";
	}
	else
	{
...
<html lang="en">
  ...
  <body>
              ...
              <div class="container box-bg">
                <div class="box">
                    <div class="box-header">
                      <div class="row">
                        <div class="col-lg-6"><h3 class="box-heading"> Unit <small>Add / Update  Details</small></h3></h3></div>
                        <div class="col-lg-6">
                          <div class="breadcrumb">
                            <a href="index.php" class="breadcrumb_a">Home</a> 
                            <i class="fa fa-angle-double-right angle_double_right"></i>
                            <a href="unit_view.php" class="breadcrumb_a">Unit </a> 
                            <i class="fa fa-angle-double-right angle_double_right" aria-hidden="true"></i>
                            <a href="#" class="breadcrumb_a">Add / Update Unit </a>
                          </div>
                        </div>
                      </div>
                    </div>
	...
	if($update == "yes"){
	$sel_row = mysqli_query($link,"select * from unit_tbl where `unit_id`='$unit_id'");
	$row = mysqli_fetch_object($sel_row);
	$upload_id = $row->unit_id;
	}
	else
	{
	$max_id = maxOfAll("id","unit_tbl");
	$max_id=$max_id+1;
	$upload_id="uni-".$max_id;
	}
	?>
                        <div class="row mt-3">
                          <div class="col-md-12">
  ...
  <div class="alert alert-success alert-dismissible">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
      <div class="form-group row">
        ...
        <label class="margin-left-10" for="industry_name">Unit  Id</label>
        </div>
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-pad">
          <input type="text" class="form-control" name="unit_id" id="unit_id" placeholder="Enter the Unit Id" value="<?php echo $upload_id; ?>" readonly="readonly" required="required">
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
      <div class="form-group row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-pad">
        <label class="margin-left-10" for="industry_name">Unit Name</label>
        </div>
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-pad">
         <input type="text" class="form-control" name="unit_name" id="unit_name" placeholder="Enter the Unit Name" value="<?php echo $row->unit_name; ?>" required="required">
        </div>
      </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
