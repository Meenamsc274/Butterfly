...
$gst_summary = "yes";
$payment_summary = "yes";
$po_no = filter($_GET['po_no']);
$sel_invoice = mysqli_query($link,"select * from purchaseorder_tbl where po_no='$po_no'");
...
<head>
    ...
    <meta name="description" content="<?php echo $company_name; ?> Purchase Order">
    <meta name="author" content="<?php echo $company_name; ?> Purchase Order">
    <!-- Bootstrap 3.3.7 -->
...
<br>
<center style="text-decoration:underline;"><h2>Purchase Order</h2></center>
<br>
</div>
<div class="row">
...
<div class="col-xs-12 col-md-12">
      ...
      <?php
 	  $sel_order1 = mysqli_query($link,"select * from  purchaseorderdetails_tbl where po_no='$po_no'");
	  $sno=1;
...
<i class="fa fa-print"> </i> Print Purchase Order</button>
