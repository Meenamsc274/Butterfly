...
$sel_invoice = mysqli_query($link,"select * from purchase_tbl where invoice_no='$invoice_no'");
...
<br>
<center style="text-decoration:underline;"><h2>Purchase Invoice</h2></center>
<br>
</div>
<hr>
<div class="row">
    ...
    <div class="col-xs-4 col-md-4">
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              <td>Purchase Invoice Date :<?php  echo $invoice_date = date("d-m-Y", strtotime($rw_details->purchase_date));  ?></td>
            </tr>
            <tr>
...
<div class="col-xs-12 col-md-12">
      ...
      <?php
 	  $sel_order1 = mysqli_query($link,"select * from  purchasedetails_tbl where invoice_no='$invoice_no'");
	  $sno=1;
