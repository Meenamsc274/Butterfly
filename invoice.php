...
$branch_details_show = "yes";
$customer_details_show = "yes";
if($branch_details_show == "yes" && $customer_details_show == "yes"){
$grid_size = "col-xs-4 col-md-4";
}
else
{
$grid_size = "col-xs-8 col-md-8";	
}	
$gst_summary = "yes";
$payment_summary = "yes";
$invoice_no = filter($_GET['invoice_no']);
$sel_invoice = mysqli_query($link,"select * from sales_tbl where invoice_no='$invoice_no'");
$rw_details = mysqli_fetch_object($sel_invoice);
$customer_id = $rw_details->customer_id;
...
$customer_details =  $customer_address.", ".$customer_area.", ".$customer_city.", ".$customer_district.", ".$customer_state.", ".$customer_country.", ".$customer_pincode;
...
<br>
<center style="text-decoration:underline;"><h2>Invoice</h2></center>
<br>
</div>
<div class="row">
<div class="col-xs-12 col-md-12">
  <div class="row">
	<?php if($branch_details_show == "yes"){ ?>
    <div class="<?php echo $grid_size; ?>">
	...
	<?php } if($customer_details_show == "yes"){ ?>
    <div class="<?php echo $grid_size; ?>">
        <table class="table table-bordered">
          <thead>
            <tr>
          ...
          <tbody>
            <tr><td><?php echo $customer_name;?></td></tr>
			<tr><td><?php echo $customer_details;?></td></tr>
			<tr><td><i class="fa fa-phone"></i> <?php echo $customer_mobile_number; ?> <i class="fa fa-envelope"></i> <?php echo $customer_email_id; ?></td></tr>
			<tr><td>GST No: <?php echo $customer_gst_no; ?></td></tr>
          </tbody>
        </table>
      </div>
	<?php } ?>  
    <div class="col-xs-4 col-md-4">
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              <td>Invoice No : <?php echo $rw_details->invoice_no;?></td>
            </tr>
            <tr>
              <td>Invoice Date :<?php  echo $invoice_date = date("d-m-Y", strtotime($rw_details->sales_date));  ?></td>
            </tr>
            <tr>
              <td><center><img src="<?php echo $rw_details->invoice_barcode;?>" alt="barcode"  class="img-responsive" /></center></td>
            </tr>
			<tr>
              <td>PO No : <?php echo $rw_details->po_no;?> | PO Date : <?php  echo $po_date = date("d-m-Y", strtotime($rw_details->po_date));  ?></td>
            </tr>
          </tbody>
        </table>
      </div>
...
<div class="col-xs-12 col-md-12">
      ...
      <?php
 	  $sel_order1 = mysqli_query($link,"select * from  salesdetails_tbl where invoice_no='$invoice_no'");
	  $sno=1;
	  ...
	  <tr>
		...
		<tr>
			...
			<tbody>
				<tr>
					<td width="50%"><b>For <?php echo $customer_name; ?> (Seal & Signature)</b></td>
